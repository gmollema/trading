"""Test different stop loss levels to find optimal."""

from pathlib import Path
from trading_bot.backtest.rsi2_signals import find_rsi2_long_trades
from trading_bot.cli.rsi2_backtest import load_bars, WINDOWS, in_window, summarize

bars = load_bars("^GSPC", Path("backtest_data/daily_index"))

print("Testing different stop loss levels on RSI2 strategy")
print("S&P 500 (^GSPC) - Post-video period (2021-07-01 onwards)\n")
